...
export declare class ArweaveError extends Error {
    ...
    constructor(message: string, code: string, transactionId?: string | undefined, details?: Record<string, any> | undefined);
}
export declare class ArweaveUploadError extends ArweaveError {
    dataSize?: number | undefined;
    cost?: string | undefined;
    constructor(message: string, dataSize?: number | undefined, cost?: string | undefined, details?: Record<string, any>);
}
export declare class ArweaveRetrievalError extends ArweaveError {
    transactionId: string;
    gateway?: string | undefined;
    constructor(message: string, transactionId: string, gateway?: string | undefined, details?: Record<string, any>);
}
export declare class ArweaveWalletError extends ArweaveError {
    walletAddress?: string | undefined;
    constructor(message: string, walletAddress?: string | undefined, details?: Record<string, any>);
}
